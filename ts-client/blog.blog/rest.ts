...
export interface BlogHelp {
  /** @format uint64 */
  id?: string;
  creator?: string;
}

export interface BlogMsgCreateHelpResponse {
  /** @format uint64 */
  id?: string;
}
...
export type BlogMsgDeleteHelpResponse = object;

export type BlogMsgDeletePostResponse = object;

export type BlogMsgUpdateHelpResponse = object;
...
export interface BlogQueryAllHelpResponse {
  Help?: BlogHelp[];
...
export interface BlogQueryGetHelpResponse {
  Help?: BlogHelp;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryHelpAll = (
    ...
    this.request<BlogQueryAllHelpResponse, RpcStatus>({
      path: `/blog/blog/help`,
      method: "GET",
      query: query,
      format: "json",
   ...
   * @tags Query
   * @name QueryHelp
   * @summary Queries a list of Help items.
   * @request GET:/blog/blog/help/{id}
   */
  queryHelp = (id: string, params: RequestParams = {}) =>
    this.request<BlogQueryGetHelpResponse, RpcStatus>({
      path: `/blog/blog/help/${id}`,
      method: "GET",
      format: "json",
      ...params,
    });
